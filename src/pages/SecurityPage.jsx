...
const SecurityPage = () => {
  ...
  const securityServices = [
    { icon: Search, title: 'AI Security Audit', description: 'Comprehensive AI-powered security assessment of your digital infrastructure', price: '$20', delivery: '24 hours', features: ['Automated vulnerability scanning', 'AI-powered threat detection', 'Detailed security report'], link: '/services/AiSecurityAudit' },
    { icon: Shield, title: 'Vulnerability Assessment', description: 'Deep dive analysis to identify security weaknesses in your systems', price: '$50', delivery: '48 hours', features: ['Manual security testing', 'Code review', 'Network analysis'], link: '/services/VulnerabilityAssessment' },
    { icon: Lock, title: 'Penetration Testing', description: 'Ethical hacking to identify and exploit security vulnerabilities', price: '$150', delivery: '5 days', features: ['Full penetration testing', 'Exploit demonstration', 'Remediation guidance'], link: '/services/PenetrationTesting' },
    { icon: Zap, title: 'Real-time Monitoring', description: '24/7 threat detection and alerting system for your infrastructure', price: '$99/mo', delivery: 'Instant setup', features: ['24/7 monitoring', 'Instant alerts', 'Monthly reports'], link: '/services/RealtimeMonitoring' },
    { icon: Users, title: 'Security Consultation', description: 'Expert guidance tailored to your specific security needs', price: '$75', delivery: 'Flexible', features: ['One-on-one consultation', 'Custom security strategy', 'Implementation support'], link: '/services/SecurityConsultation' },
    { icon: FileCheck, title: 'Compliance Audit', description: 'Ensure your systems meet industry regulatory requirements', price: '$200', delivery: '7 days', features: ['GDPR/HIPAA compliance', 'Documentation review', 'Compliance roadmap'], link: '/services/ComplianceAudit' }
  ];

  const testimonials = [
    { name: 'Sarah Chen', role: 'CTO, TechStart Inc', text: 'CyberSage identified critical vulnerabilities we never knew existed. Their AI-powered approach saved us weeks of manual testing.' },
    { name: 'Michael Roberts', role: 'Founder, SecureApp', text: 'The threat report was incredibly detailed yet easy to understand. Implementation was straightforward with their clear recommendations.' },
    { name: 'Emily Watson', role: 'Product Manager, CloudSafe', text: 'Enterprise-grade security at a fraction of the cost. CyberSage gave us peace of mind without breaking our budget.' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      ...
      <div className="py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">Protecting Your Digital Assets</h1>
          <p className="text-base sm:text-lg text-gray-400 mx-auto">AI-powered cybersecurity solutions for startups, small businesses, and freelancers. Fast, actionable, and accessible.</p>
        </div>
      </div>
      ...
      <div id="services" className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-8">Our Security Services</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {securityServices.map((service, index) => {
              const IconComponent = service.icon;
              return (
                <Card key={index} className="bg-slate-900/60 border-slate-700 hover:border-blue-500/50 cursor-pointer" onClick={() => navigate(service.link)}>
                  <CardHeader>
                    ...
                    <CardDescription className="text-slate-400 text-sm">{service.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
      ...
      <div id="testimonials" className="py-12 px-4 bg-gray-900/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-8">What Our Clients Say</h2>
      ...
      <div id="contact" className="py-12 px-4">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Ready to Secure Your Assets?</h2>
          <p className="text-base sm:text-lg text-gray-400 mb-6">Get in touch with our security experts today</p>
